...
c-----------------------------------------------------------------------
      subroutine genmap_session_store(mode,s)
      integer mode
      character*1 s(1)
      character*80 saved
      character*1 saved1(80)
      equivalence (saved1,saved)
      save saved

      if (mode.eq.0) call chcopy(saved1,s,80)
      if (mode.eq.1) call chcopy(s,saved1,80)
...
c
      ...
      character*1  session1(80)
      equivalence (session1,session)
...
c     Get file name
   ...
   81 format(80a1)
      ...
      read(5,80) session
      call genmap_session_store(0,session1)
   80 format(a80)
...
c      ifma2 = .false. ! force .map
      ...
      call genmap_session_store(1,session1)
      len = ltrunc(session,80)
      call chcopy(fnam1,session1,80)
      if (ifma2) then
